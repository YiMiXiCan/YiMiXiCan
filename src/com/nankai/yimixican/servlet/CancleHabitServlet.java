...
/**
 * Servlet implementation class CancleHabitServlet
 */
public class CancleHabitServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CancleHabitServlet() {
        super();
