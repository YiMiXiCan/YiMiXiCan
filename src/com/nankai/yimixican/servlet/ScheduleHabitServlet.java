...
/**
 * Servlet implementation class ScheduleHabitServlet
 */
public class ScheduleHabitServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ScheduleHabitServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Habit> lstMessages = habitBiz.showHabitsByClassID(2);
